...
namespace GLFW {
    public partial class GLFW3 {
         ...
         *  @ingroup init
         */
        internal static extern const char* glfwGetVersionString();
         ...
         *  @ingroup monitor
         */
        internal static extern GLFWmonitor** glfwGetMonitors(int* count);
         ...
         *  @ingroup monitor
         */
        internal static extern const char* glfwGetMonitorName(GLFWmonitor* monitor);
         ...
         *  @ingroup monitor
         */
        internal static extern const GLFWvidmode* glfwGetVideoModes(GLFWmonitor* monitor, int* count);
         ...
         *  @ingroup monitor
         */
        internal static extern const GLFWvidmode* glfwGetVideoMode(GLFWmonitor* monitor);
         ...
         *  @ingroup monitor
         */
        internal static extern const GLFWgammaramp* glfwGetGammaRamp(GLFWmonitor* monitor);
         ...
         *  @ingroup window
         */
        internal static extern GLFWwindow* glfwCreateWindow(int width, int height, const char* title, GLFWmonitor* monitor, GLFWwindow* share);
         ...
         *  @ingroup window
         */
        internal static extern void glfwGetWindowSize(GLFWwindow* window, int* width, int* height);
         ...
         *  @ingroup window
         */
        internal static extern int glfwGetWindowAttrib(GLFWwindow* window, int attrib);
         ...
         *  @ingroup window
         */
        internal static extern void glfwSetWindowUserPointer(GLFWwindow* window, void* pointer);
         ...
         *  @ingroup window
         */
        internal static extern void* glfwGetWindowUserPointer(GLFWwindow* window);
         ...
         *  @ingroup window
         */
        internal static extern GLFWwindowposfun glfwSetWindowPosCallback(GLFWwindow* window, GLFWwindowposfun cbfun);
         ...
         *  @ingroup window
         */
        internal static extern GLFWwindowfocusfun glfwSetWindowFocusCallback(GLFWwindow* window, GLFWwindowfocusfun cbfun);
         ...
         *  @ingroup window
         */
        internal static extern GLFWwindowiconifyfun glfwSetWindowIconifyCallback(GLFWwindow* window, GLFWwindowiconifyfun cbfun);
         ...
         *  @ingroup input
         */
        internal static extern void glfwGetCursorPos(GLFWwindow* window, double* xpos, double* ypos);
         ...
         *  @ingroup input
         */
        internal static extern GLFWcursor* glfwCreateCursor(const GLFWimage* image, int xhot, int yhot);
         ...
         *  @ingroup input
         */
        internal static extern GLFWcursor* glfwCreateStandardCursor(int shape);
         ...
         *  @ingroup input
         */
        internal static extern const float* glfwGetJoystickAxes(int joy, int* count);
         ...
         *  @ingroup input
         */
        internal static extern const unsigned char* glfwGetJoystickButtons(int joy, int* count);
         ...
         *  @ingroup input
         */
        internal static extern const char* glfwGetJoystickName(int joy);
         ...
         *  @ingroup input
         */
        internal static extern const char* glfwGetClipboardString(GLFWwindow* window);
         ...
         *  @ingroup context
         */
        internal static extern int glfwExtensionSupported(const char* extension);
         ...
         *  @ingroup context
         */
        internal static extern GLFWglproc glfwGetProcAddress(const char* procname);
    }
}
